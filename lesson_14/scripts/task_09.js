...
//Умова: Знайти кількість товарів, у яких ціна зменшилась (price < old_price).
...
if (confirm(`Shall we start the test?`)) {
   ...
   const countDecreasedPrice = dataList.filter(item => item.price < item.old_price).length;

   document.write(countDecreasedPrice);
}