...
//Умова: Знайти: Товари, які доступні (sell_status:"available").
...
if (confirm(`Shall we start the test?`)) {
   ...
   const countDecreasedPriceAvailable = dataList.filter(item => item.price < item.old_price && item.sell_status === 'available').length;

   document.write(countDecreasedPriceAvailable);
}