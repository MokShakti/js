...
//Умова: Дано інформацію про прибуток К магазинів протягом тижня. Знайти: Загальний прибуток за вихідні дні.
...
if (confirm(`Shall we start the test?`)) {
   ...
   document.write(`Total sum for weekend is: ${dayIncome}`)
}